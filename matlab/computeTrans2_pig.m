function Trans = computeTrans2_pig(varargin)
...
KnownTransducers = {'L7-4',       '000250',  96,   0;...
                    ...
                    'MUSIC3_Biobox',          '04AA73',  96,   0;...
                    'MUSIC3_Biobox64',        '04AA73',  96,   0;...
           ...
           case 'GE4CD'
            ...
            case 'GEM5ScD'
                ...
                Trans.ConnectorES(81:160, 1) = 48 + [17:32, 49:64, 73:80, 89:96, 113:128, 145:160]'; % outer rows of elements
                  ...
                  case 'GEL8-18i_64' % for 64 channel system
