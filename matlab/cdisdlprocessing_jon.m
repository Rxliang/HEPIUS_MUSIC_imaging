function IQOut = cdisdlprocessing_jon(IQData);
% Notice: 
...
procIndSDLarge = evParms.proc.procIndSDLarge;

pc = {Process.classname};

pwrThres = evParms.largeSDParms.pwrThres;
DopState = evParms.largeSDParms.SDLargeCDIMode;
imgPID =  procIndSDLarge; %must match script, doppler Imag process % strmatch('Image',pc,'exact') ;
