function Trans = computeTrans2_mbc(varargin)
...
KnownTransducers = {'L7-4',       '000250',  96,   0;...
                    ...
                    'Two IP-105s',            '04AA73',  96,   1;... % HIFUPlex imaging Probe, pairings 1, 2, 3
...
%keyboard;
                ...
                Trans.impedance = 50; %Need to actually set this to match what's read from the Network Analyzer.
                Trans.elevationApertureMm = 2; % active elevation aperture in mm 
                Trans.elevationFocusMm = 7; % nominal elevation focus depth from lens on face of transducer
