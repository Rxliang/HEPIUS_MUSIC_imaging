...
recordDataFileName = [vtData '/tmp/recordDataFile.mat'];
global recordData;
...
[successFlag] = getRecordingInfo(semaphoreOpenedState)
recordData.recordState

function [successFlag] = getRecordingInfo(semaphoreOpenedState)
    global semaphoreKey;
    global recordDataFileName;
    global recordData; 
