...
if usem5
  ...
  SWIROI.height = 120; % was 50;  % [width and height in wavelength]
else
    % Define ROI for IQ processing, can be changed in GUI
  SWIFocusX = 0;
  SWIFocusZ = 15; % was 50
...
for q = 2:nTX
  ...
  TX(q).Apod(numElementsUsed/2-TX(q).pushElements/2 +1 : ...
             numElementsUsed/2+TX(q).pushElements/2) = 1;
...
if 1
savesweiq(IQ, SWIROI.width, SWIROI.height, ...
