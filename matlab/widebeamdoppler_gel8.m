...
P.dopTxOrgChnl = round([48 71 94 117]*168/192);
P.dopDispEle = 92; % middle 92 elements width will be used for Doppler display
P.dopNumTx =  floor(P.dopTxOrgChnl(1)*2);  % no. of elements in TX aperture
...
halfChan = Trans.numelements/2-1/2;
fullChan =  Trans.numelements-1;
TxOrgX = (-halfChan*Trans.spacing):(fullChan*Trans.spacing/(P.numRays-1)):(halfChan*Trans.spacing);
...
% 30% relative BW from filterTool with 10.417 center
BPF = [-0.00006 +0.00000 -0.00018 +0.00000 +0.00183 +0.00000 -0.00659 ...
 +0.00000 +0.01654 +0.00000 -0.03314 +0.00000 +0.05621 +0.00000 ...
 -0.08301 +0.00000 +0.10861 +0.00000 -0.12717 +0.00000 +0.13391];
