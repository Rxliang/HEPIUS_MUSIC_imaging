...
Trans.frequency = 12.5;
%Trans.frequency = 8.9286;
%Trans.frequency = 6.9444;
...
if 0
  ...
  P.txFocus_mm = 4; P.endDepth_mm = 8; P.endDepth_mm = 12; % 12 to
                                                           % see
                                                           % ulnar nerve 
  ttna_us = 125;
  ttnaFrame_us = 77000;
...
Resource.DisplayWindow.Title = 'L8-18i rylns 4X sampling at 62.5 MHz';
