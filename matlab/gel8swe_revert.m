...
zFocus = SWIFocusZ-floor(numPush/2)*pushSep_mm:pushSep_mm:SWIFocusZ+floor(numPush/2)*pushSep_mm;
...
SeqControl(5).argument = ttnaPush_us;               % 500usec
afterpush = 5;
...
SeqControl(7).argument = ttnEB_us;            % 200000usec = 200msec (~ 5 fps)
TTNEB=7;
...
for i = 1:SWIFrames
    ...
    for q = 1:numPush
      ...
      if q == numPush
        ...
        Event(n).seqControl = [ttnaPushInterval_us];
      end      
      n = n+1;
    end
