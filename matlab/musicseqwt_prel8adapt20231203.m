...
largeSDParms.maxPower=100; % default power to override B-mode, was 10 JSM
...
FOV.dopAngle = 22 * pi/180; % angle for Doppler flash transmits.
...
if (usec15 | usem5 | use6s | useMusic) & doCFI
...
if doCFI
  ...
  UI(uiInd).Control = {slider.dopplerpwrthresh.pos,'Style','VsSlider',...
                      'Label','CFIDopPwrThres','SliderMinMaxVal', ...
