...
simulateMode = 2;
interIndSD = 2; % interbuffer used by offlinesdmusic in post-analysis
...
% change dec to jan 2024
%P.useElem = [129, 192] %[1, 64];
...
dop.saveData = 0;
dop.fname = 'MUSIC_Plane_WeakFlowHigh_Spectral';
dop.cpl = 70;   
...
if simulateMode ==2
  fn = '20240103_MUSIC_Plane_WeakFlowHigh_Spectral.mat';
  fn = '20240111_MUSIC_Plane_WeakFlowHigh_Spectral.mat';
...
Process(6).method = 'spectralDoppler_JP20231215';
