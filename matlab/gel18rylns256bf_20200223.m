...
mfile = mfilename;
P.startDepth = 5;
P.endDepth = 50;     % Acquisition depth in wavelengths
...
SeqControl(1).argument = 150;  % 200 usec between ray lines
SeqControl(2).command = 'timeToNextAcq';
SeqControl(2).argument = round(44400 - (Trans.numelements-1)*SeqControl(1).argument); % 22.5 frames per second
